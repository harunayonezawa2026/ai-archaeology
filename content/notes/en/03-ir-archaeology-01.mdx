...
6. Year the Apple iPhone supply deal began
7. HBM development and mass production years
8. Pivot toward AI semiconductors
9. Relationships with competitors (Hynix / Micron / Toshiba / Intel)
10. Generational succession of CEOs and senior leadership
```

### Lineage-analysis prompt (the most powerful one)

```
Build a correspondence table between the 1996 Samsung 1Gbit DRAM and the
core technology of modern HBM3/HBM4, at the level of the engineering
problem each one was solving. Along which scaling axes are the two
solving the same shape of problem?
```

This single prompt produced the entire correspondence table in section 3 in one shot.
